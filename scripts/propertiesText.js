export const properties = {
	"text": {
		...
		"color": `↓<b>color</b>: цвет; – задаёт цвет текста
<i>color: green;</i> (canvastext)`,
		"font-size": `↓<b>font-size</b>: размер; – задаёт размер текста
font-size: 25px; (medium)`,
		"font-family": `↓<b>font-family</b>: имя■шрифта1, имя■шрифта2, тип■шрифта; – задаёт шрифт текста
...
font-family: Arial, sans-serif; (браузерное значение)`,
		"font-face": `@<b>font-face</b> {текст из внешнего файла} – внедряет в документ шрифт из внешнего файла
...
@font-face {
	...
	src: url(fonts/caprica-script-personal-use.eot?#iefix) format("embedded-opentype"),
		...
		"font-style": `↓<b>font-style</b>: начертание; – задаёт начертание текста
Начертания:
1. normal – обычное начертание
2. italic – курсивное начертание
3. oblique – наклонное начертание
font-style: italic; (normal)`,
		"font-variant": `↓<b>font-variant</b>: значение; – управляет регистром текста
Значения:
1. normal – обычное начертание
2. small-caps – все символы становятся малыми заглавными
font-style: small-caps; (normal)`,
		"text-transform": `↓<b>text-transform</b>: значение; – управляет регистром текста
Значения:
