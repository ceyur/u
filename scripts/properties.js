...
2. maх-width – задаёт максимальную ширину`,
"example": "width: 150px;",
"default": " (auto)"
		},
		"height": {
...
2. maх-height – задаёт максимальную высоту`,
...
"start": "",
"name": "right",
"value": `: размер; – задаёт размер правого внутреннего отступа для позиционируемого элемента`,
"example": "right: 20px;",
"default": " (auto)"
		},
		"bottom": {
"start": "",
"name": "bottom",
"value": `: размер; – задаёт размер нижнего внутреннего отступа для позиционируемого элемента`,
"example": "bottom: 30%;",
"default": " (auto)"
		},
		"left": {
"start": "",
"name": "left",
"value": `: размер; – задаёт размер левого внутреннего отступа для позиционируемого элемента`,
"example": "left: 230px;",
"default": " (auto)"
		},
		"z-index": {
