...
Object.keys(objects).forEach(key => {
  ...
  div.innerHTML = `<button><svg viewBox="0 0 4 4" width="29px" height="29px" stroke="black" stroke-width="0.4" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M1 1.5l1 1l1 -1"/></svg></button><iframe></iframe>`;
